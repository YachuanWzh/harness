...
### 修复
- 修复 macOS 自带 Bash 3.2 执行项目初始化器时的语法错误：Claude 文档模板不再使用 heredoc 命令替换，避免含单引号的文案破坏旧版解析器状态并在后续 FLAVOR.md 模板处误报

### 测试
- 新增 macOS Bash 3.2 解析回归测试，并在 Bash 3.2.57 与 Bash 5.3 下验证安装脚本
